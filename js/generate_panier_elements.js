function generate_panier_elements()
{
    var main_container_p = document.getElementById('main-container');

    var nb_articles = retourne_nb_articles_panier();
	...
	{
	    var id_of_object = parse_objet_string();
	    ...
	    newdiv5.innerHTML = article_en_cours.get_prix();
